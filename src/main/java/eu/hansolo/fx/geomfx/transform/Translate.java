...
public class Translate extends BaseTransform {
    ...
    @Override public void transform(Rect rect, Rect result) { transform(rect, result, mxt, myt); }
    ...
    @Override public void inverseTransform(Rect rect, Rect result) {
        transform(rect, result, -mxt, -myt);
    }

    static void transform(Rect rect, Rect result, double mxt, double myt) {
        int imxt = (int) mxt;
        int imyt = (int) myt;
